...
import com.example.stephen.fatcat.PaymentsFragment.OnListFragmentInteractionListener;
...
public class MyPaymentsRecyclerViewAdapter extends RecyclerView.Adapter<MyPaymentsRecyclerViewAdapter.ViewHolder> {
    ...
    public MyPaymentsRecyclerViewAdapter(List<PaymentsItem> items, OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
