...
import edu.umd.cs.fatcat.FriendListFragment.OnListFragmentInteractionListener;
 ...
 * specified {@link FriendListFragment.OnListFragmentInteractionListener}.
...
public class MyFriendListRecyclerViewAdapter extends RecyclerView.Adapter<MyFriendListRecyclerViewAdapter.ViewHolder> {
    ...
    public MyFriendListRecyclerViewAdapter(List<FatcatFriend> items, FriendListFragment.OnListFragmentInteractionListener listener) {
        mValues = items;
        mListener = listener;
    }
